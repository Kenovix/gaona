...
class AgendaType extends AbstractType
{
    ...
    {
        $builder
        ->add('fecha_inicio', 'datetime', array('label' => 'Fecha de inicio', 'years' => range(2017, 2018), 'required' => true))
        ->add('fecha_fin', 'datetime', array('label' => 'Fecha de fin', 'years' => range(2017, 2018), 'required' => true))
